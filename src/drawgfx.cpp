...
static void pp_8_nd(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[y][x] = p;
}
static void pp_8_nd_fx(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[y][b->width - 1 - x] = p;
}
static void pp_8_nd_fy(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[b->height - 1 - y][x] = p;
}
static void pp_8_nd_fxy(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[b->height - 1 - y][b->width - 1 - x] = p;
}
static void pp_8_nd_s(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[x][y] = p;
}
static void pp_8_nd_fx_s(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[x][b->width - 1 - y] = p;
}
static void pp_8_nd_fy_s(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[b->height - 1 - x][y] = p;
}
static void pp_8_nd_fxy_s(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[b->height - 1 - x][b->width - 1 - y] = p;
}

static void pp_8_d(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[y][x] = p;
    osd_mark_dirty(x, y, x, y, 0);
}
static void pp_8_d_fx(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->width - 1 - x;
    b->line[y][x] = p;
    osd_mark_dirty(x, y, x, y, 0);
}
static void pp_8_d_fy(struct osd_bitmap *b, int x, int y, int p)
{
    y = b->height - 1 - y;
    b->line[y][x] = p;
    osd_mark_dirty(x, y, x, y, 0);
}
static void pp_8_d_fxy(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->width - 1 - x;
    y = b->height - 1 - y;
    b->line[y][x] = p;
...
static void pp_8_d_s(struct osd_bitmap *b, int x, int y, int p)
{
    b->line[x][y] = p;
    osd_mark_dirty(y, x, y, x, 0);
}
static void pp_8_d_fx_s(struct osd_bitmap *b, int x, int y, int p)
{
    y = b->width - 1 - y;
    b->line[x][y] = p;
    osd_mark_dirty(y, x, y, x, 0);
}
static void pp_8_d_fy_s(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->height - 1 - x;
    b->line[x][y] = p;
    osd_mark_dirty(y, x, y, x, 0);
}
static void pp_8_d_fxy_s(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->height - 1 - x;
    y = b->width - 1 - y;
    b->line[x][y] = p;
...
static void pp_16_nd(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[y]) [x] = p;
}
static void pp_16_nd_fx(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[y]) [b->width - 1 - x] = p;
}
static void pp_16_nd_fy(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[b->height - 1 - y]) [x] = p;
}
static void pp_16_nd_fxy(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[b->height - 1 - y]) [b->width - 1 - x] = p;
}
static void pp_16_nd_s(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[x]) [y] = p;
}
static void pp_16_nd_fx_s(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[x]) [b->width - 1 - y] = p;
}
static void pp_16_nd_fy_s(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[b->height - 1 - x]) [y] = p;
}
static void pp_16_nd_fxy_s(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[b->height - 1 - x]) [b->width - 1 - y] = p;
}

static void pp_16_d(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[y]) [x] = p;
    osd_mark_dirty(x, y, x, y, 0);
}
static void pp_16_d_fx(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->width - 1 - x;
    ((UINT16 *) b->line[y]) [x] = p;
    osd_mark_dirty(x, y, x, y, 0);
}
static void pp_16_d_fy(struct osd_bitmap *b, int x, int y, int p)
{
    y = b->height - 1 - y;
    ((UINT16 *) b->line[y]) [x] = p;
    osd_mark_dirty(x, y, x, y, 0);
}
static void pp_16_d_fxy(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->width - 1 - x;
    y = b->height - 1 - y;
    ((UINT16 *) b->line[y]) [x] = p;
...
static void pp_16_d_s(struct osd_bitmap *b, int x, int y, int p)
{
    ((UINT16 *) b->line[x]) [y] = p;
    osd_mark_dirty(y, x, y, x, 0);
}
static void pp_16_d_fx_s(struct osd_bitmap *b, int x, int y, int p)
{
    y = b->width - 1 - y;
    ((UINT16 *) b->line[x]) [y] = p;
    osd_mark_dirty(y, x, y, x, 0);
}
static void pp_16_d_fy_s(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->height - 1 - x;
    ((UINT16 *) b->line[x]) [y] = p;
    osd_mark_dirty(y, x, y, x, 0);
}
static void pp_16_d_fxy_s(struct osd_bitmap *b, int x, int y, int p)
{
    x = b->height - 1 - x;
    y = b->width - 1 - y;
    ((UINT16 *) b->line[x]) [y] = p;
...
static int rp_8(struct osd_bitmap *b, int x, int y)
{
    return b->line[y][x];
}
static int rp_8_fx(struct osd_bitmap *b, int x, int y)
{
    return b->line[y][b->width - 1 - x];
}
static int rp_8_fy(struct osd_bitmap *b, int x, int y)
{
    return b->line[b->height - 1 - y][x];
}
static int rp_8_fxy(struct osd_bitmap *b, int x, int y)
{
    return b->line[b->height - 1 - y][b->width - 1 - x];
}
static int rp_8_s(struct osd_bitmap *b, int x, int y)
{
    return b->line[x][y];
}
static int rp_8_fx_s(struct osd_bitmap *b, int x, int y)
{
    return b->line[x][b->width - 1 - y];
}
static int rp_8_fy_s(struct osd_bitmap *b, int x, int y)
{
    return b->line[b->height - 1 - x][y];
}
static int rp_8_fxy_s(struct osd_bitmap *b, int x, int y)
{
    return b->line[b->height - 1 - x][b->width - 1 - y];
}

static int rp_16(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[y]) [x];
}
static int rp_16_fx(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[y]) [b->width - 1 - x];
}
static int rp_16_fy(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[b->height - 1 - y]) [x];
}
static int rp_16_fxy(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[b->height - 1 - y]) [b->width - 1 - x];
}
static int rp_16_s(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[x]) [y];
}
static int rp_16_fx_s(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[x]) [b->width - 1 - y];
}
static int rp_16_fy_s(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[b->height - 1 - x]) [y];
}
static int rp_16_fxy_s(struct osd_bitmap *b, int x, int y)
{
    return ((UINT16 *) b->line[b->height - 1 - x]) [b->width - 1 - y];
}


static void pb_8_nd(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    while (h-- > 0) {
        int c = w;
...
static void pb_8_nd_fx(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    while (h-- > 0) {
        int c = w;
...
static void pb_8_nd_fy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->height - 1 - y;
    while (h-- > 0) {
...
static void pb_8_nd_fxy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    y = b->height - 1 - y;
    while (h-- > 0) {
...
static void pb_8_nd_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    while (h-- > 0) {
        int c = w;
...
static void pb_8_nd_fx_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->width - 1 - y;
    while (h-- > 0) {
...
static void pb_8_nd_fy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    while (h-- > 0) {
        int c = w;
...
static void pb_8_nd_fxy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    y = b->width - 1 - y;
    while (h-- > 0) {
...
static void pb_8_d(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
...
static void pb_8_d_fx(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
...
static void pb_8_d_fy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->height - 1 - y;
...
static void pb_8_d_fxy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    y = b->height - 1 - y;
...
static void pb_8_d_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
...
static void pb_8_d_fx_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->width - 1 - y;
...
static void pb_8_d_fy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
...
static void pb_8_d_fxy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    y = b->width - 1 - y;
...
static void pb_16_nd(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    while (h-- > 0) {
        int c = w;
...
static void pb_16_nd_fx(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    while (h-- > 0) {
        int c = w;
...
static void pb_16_nd_fy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->height - 1 - y;
    while (h-- > 0) {
...
static void pb_16_nd_fxy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    y = b->height - 1 - y;
    while (h-- > 0) {
...
static void pb_16_nd_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    while (h-- > 0) {
        int c = w;
...
static void pb_16_nd_fx_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->width - 1 - y;
    while (h-- > 0) {
...
static void pb_16_nd_fy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    while (h-- > 0) {
        int c = w;
...
static void pb_16_nd_fxy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    y = b->width - 1 - y;
    while (h-- > 0) {
...
static void pb_16_d(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    osd_mark_dirty(t, y, t + w - 1, y + h - 1, 0);
    while (h-- > 0) {
...
static void pb_16_d_fx(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    osd_mark_dirty(t - w + 1, y, t, y + h - 1, 0);
    while (h-- > 0) {
...
static void pb_16_d_fy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->height - 1 - y;
    osd_mark_dirty(t, y - h + 1, t + w - 1, y, 0);
...
static void pb_16_d_fxy(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->width - 1 - x;
    y = b->height - 1 - y;
    osd_mark_dirty(t - w + 1, y - h + 1, t, y, 0);
...
static void pb_16_d_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    osd_mark_dirty(y, t, y + h - 1, t + w - 1, 0);
    while (h-- > 0) {
...
static void pb_16_d_fx_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = x;
    y = b->width - 1 - y;
    osd_mark_dirty(y - h + 1, t, y, t + w - 1, 0);
...
static void pb_16_d_fy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    osd_mark_dirty(y, t - w + 1, y + h - 1, t, 0);
    while (h-- > 0) {
...
static void pb_16_d_fxy_s(struct osd_bitmap *b, int x, int y, int w, int h, int p)
{
    int t = b->height - 1 - x;
    y = b->width - 1 - y;
    osd_mark_dirty(y - h + 1, t - w + 1, y, t, 0);
