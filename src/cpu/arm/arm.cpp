...
unsigned arm_get_reg(int regnum)
{
    ...
    case ARM_R15:
        return arm.reg[15];
    case ARM_FR8:
        return arm.reg_firq[0];
    case ARM_FR9:
        return arm.reg_firq[1];
    case ARM_FR10:
        return arm.reg_firq[2];
    case ARM_FR11:
        return arm.reg_firq[3];
    case ARM_FR12:
        return arm.reg_firq[4];
    case ARM_FR13:
        return arm.reg_firq[5];
    case ARM_FR14:
        return arm.reg_firq[6];
    case ARM_IR13:
        return arm.reg_irq[0];
    case ARM_IR14:
        return arm.reg_irq[1];
    case ARM_SR13:
        return arm.reg_svc[0];
    case ARM_SR14:
        return arm.reg_svc[1];
    }
    return 0;
}
...
const char *arm_info(void *context, int regnum)
{
    ...
    case CPU_INFO_FAMILY:
        return "Acorn Risc Machine";
    case CPU_INFO_VERSION:
        return "1.0";
    case CPU_INFO_FILE:
        return __FILE__;
    case CPU_INFO_CREDITS:
        return "Copyright 2000 hjb";
    }
