...
INLINE void stat_stack_pop(void)
{
    ...
    adsp2100.mstat = adsp2100.stat_stack[adsp2100.stat_sp][0];
    mstat_changed();
...
static void wr_ax0(INT32 val)
{
    core->ax0.s = val;
}
static void wr_ax1(INT32 val)
{
    core->ax1.s = val;
}
static void wr_mx0(INT32 val)
{
    core->mx0.s = val;
}
static void wr_mx1(INT32 val)
{
    core->mx1.s = val;
}
static void wr_ay0(INT32 val)
{
    core->ay0.s = val;
}
static void wr_ay1(INT32 val)
{
    core->ay1.s = val;
}
static void wr_my0(INT32 val)
{
    core->my0.s = val;
}
static void wr_my1(INT32 val)
{
    core->my1.s = val;
}
static void wr_si(INT32 val)
{
    core->si.s = val;
}
static void wr_se(INT32 val)
{
    core->se.s = (INT8) val;
}
static void wr_ar(INT32 val)
{
    core->ar.s = val;
}
static void wr_mr0(INT32 val)
{
    core->mr.mrx.mr0.s = val;
}
static void wr_mr1(INT32 val)
{
    core->mr.mrx.mr1.s = val;
    core->mr.mrx.mr2.s = (INT16) val >> 15;
}
static void wr_mr2(INT32 val)
{
    core->mr.mrx.mr2.s = (INT8) val;
}
static void wr_sr0(INT32 val)
{
    core->sr.srx.sr0.s = val;
}
static void wr_sr1(INT32 val)
{
    core->sr.srx.sr1.s = val;
}
static void wr_i0(INT32 val)
{
    adsp2100.i[0] = val & 0x3fff;
    adsp2100.base[0] = val & adsp2100.lmask[0];
}
static void wr_i1(INT32 val)
{
    adsp2100.i[1] = val & 0x3fff;
    adsp2100.base[1] = val & adsp2100.lmask[1];
}
static void wr_i2(INT32 val)
{
    adsp2100.i[2] = val & 0x3fff;
    adsp2100.base[2] = val & adsp2100.lmask[2];
}
static void wr_i3(INT32 val)
{
    adsp2100.i[3] = val & 0x3fff;
    adsp2100.base[3] = val & adsp2100.lmask[3];
}
static void wr_i4(INT32 val)
{
    adsp2100.i[4] = val & 0x3fff;
    adsp2100.base[4] = val & adsp2100.lmask[4];
}
static void wr_i5(INT32 val)
{
    adsp2100.i[5] = val & 0x3fff;
    adsp2100.base[5] = val & adsp2100.lmask[5];
}
static void wr_i6(INT32 val)
{
    adsp2100.i[6] = val & 0x3fff;
    adsp2100.base[6] = val & adsp2100.lmask[6];
}
static void wr_i7(INT32 val)
{
    adsp2100.i[7] = val & 0x3fff;
    adsp2100.base[7] = val & adsp2100.lmask[7];
}
static void wr_m0(INT32 val)
{
    adsp2100.m[0] = (INT16)(val << 2) >> 2;
}
static void wr_m1(INT32 val)
{
    adsp2100.m[1] = (INT16)(val << 2) >> 2;
}
static void wr_m2(INT32 val)
{
    adsp2100.m[2] = (INT16)(val << 2) >> 2;
}
static void wr_m3(INT32 val)
{
    adsp2100.m[3] = (INT16)(val << 2) >> 2;
}
static void wr_m4(INT32 val)
{
    adsp2100.m[4] = (INT16)(val << 2) >> 2;
}
static void wr_m5(INT32 val)
{
    adsp2100.m[5] = (INT16)(val << 2) >> 2;
}
static void wr_m6(INT32 val)
{
    adsp2100.m[6] = (INT16)(val << 2) >> 2;
}
static void wr_m7(INT32 val)
{
    adsp2100.m[7] = (INT16)(val << 2) >> 2;
}
static void wr_l0(INT32 val)
{
    adsp2100.l[0] = val & 0x3fff;
    adsp2100.lmask[0] = mask_table[val & 0x3fff];
    adsp2100.base[0] = adsp2100.i[0] & adsp2100.lmask[0];
}
static void wr_l1(INT32 val)
{
    adsp2100.l[1] = val & 0x3fff;
    adsp2100.lmask[1] = mask_table[val & 0x3fff];
    adsp2100.base[1] = adsp2100.i[1] & adsp2100.lmask[1];
}
static void wr_l2(INT32 val)
{
    adsp2100.l[2] = val & 0x3fff;
    adsp2100.lmask[2] = mask_table[val & 0x3fff];
    adsp2100.base[2] = adsp2100.i[2] & adsp2100.lmask[2];
}
static void wr_l3(INT32 val)
{
    adsp2100.l[3] = val & 0x3fff;
    adsp2100.lmask[3] = mask_table[val & 0x3fff];
    adsp2100.base[3] = adsp2100.i[3] & adsp2100.lmask[3];
}
static void wr_l4(INT32 val)
{
    adsp2100.l[4] = val & 0x3fff;
    adsp2100.lmask[4] = mask_table[val & 0x3fff];
    adsp2100.base[4] = adsp2100.i[4] & adsp2100.lmask[4];
}
static void wr_l5(INT32 val)
{
    adsp2100.l[5] = val & 0x3fff;
    adsp2100.lmask[5] = mask_table[val & 0x3fff];
    adsp2100.base[5] = adsp2100.i[5] & adsp2100.lmask[5];
}
static void wr_l6(INT32 val)
{
    adsp2100.l[6] = val & 0x3fff;
    adsp2100.lmask[6] = mask_table[val & 0x3fff];
    adsp2100.base[6] = adsp2100.i[6] & adsp2100.lmask[6];
}
static void wr_l7(INT32 val)
{
    adsp2100.l[7] = val & 0x3fff;
    adsp2100.lmask[7] = mask_table[val & 0x3fff];
    adsp2100.base[7] = adsp2100.i[7] & adsp2100.lmask[7];
}
static void wr_astat(INT32 val)
{
    adsp2100.astat = val & 0x00ff;
}
#if SUPPORT_2101_EXTENSIONS
static void wr_mstat(INT32 val)
{
    adsp2100.mstat = val & 0x007f;
    mstat_changed();
}
#else
static void wr_mstat(INT32 val)
{
    adsp2100.mstat = val & 0x000f;
    mstat_changed();
}
#endif
static void wr_sstat(INT32 val)
{
    adsp2100.sstat = val & 0x00ff;
}
#if SUPPORT_2101_EXTENSIONS
static void wr_imask(INT32 val)
{
    adsp2100.imask = val & 0x003f;
    check_irqs();
}
#else
static void wr_imask(INT32 val)
{
    adsp2100.imask = val & 0x000f;
    check_irqs();
}
#endif
static void wr_icntl(INT32 val)
{
    adsp2100.icntl = val & 0x001f;
    check_irqs();
}
static void wr_cntr(INT32 val)
{
    cntr_stack_push();
    adsp2100.cntr = val & 0x3fff;
}
static void wr_sb(INT32 val)
{
    core->sb.s = (INT16)(val << 11) >> 11;
}
static void wr_px(INT32 val)
{
    adsp2100.px = val;
}
#if SUPPORT_2101_EXTENSIONS
...
static void wr_tx0(INT32 val)
{
    if (adsp2105_tx_callback)(*adsp2105_tx_callback)(0, val);
}
static void wr_tx1(INT32 val)
{
    if (adsp2105_tx_callback)(*adsp2105_tx_callback)(1, val);
}
static void wr_owrctr(INT32 val)
{
    adsp2100.cntr = val & 0x3fff;
}
#endif
static void wr_topstack(INT32 val)
{
    pc_stack_push_val(val & 0x3fff);
}
...
{
    /*logerror( "ADSP %04x: Writing to an invalid register!", adsp2100.ppc ); */ return 0;
}
static INT32 rd_ax0(void)
{
    return core->ax0.s;
}
static INT32 rd_ax1(void)
{
    return core->ax1.s;
}
static INT32 rd_mx0(void)
{
    return core->mx0.s;
}
static INT32 rd_mx1(void)
{
    return core->mx1.s;
}
static INT32 rd_ay0(void)
{
    return core->ay0.s;
}
static INT32 rd_ay1(void)
{
    return core->ay1.s;
}
static INT32 rd_my0(void)
{
    return core->my0.s;
}
static INT32 rd_my1(void)
{
    return core->my1.s;
}
static INT32 rd_si(void)
{
    return core->si.s;
}
static INT32 rd_se(void)
{
    return core->se.s;
}
static INT32 rd_ar(void)
{
    return core->ar.s;
}
static INT32 rd_mr0(void)
{
    return core->mr.mrx.mr0.s;
}
static INT32 rd_mr1(void)
{
    return core->mr.mrx.mr1.s;
}
static INT32 rd_mr2(void)
{
    return core->mr.mrx.mr2.s;
}
static INT32 rd_sr0(void)
{
    return core->sr.srx.sr0.s;
}
static INT32 rd_sr1(void)
{
    return core->sr.srx.sr1.s;
}
static INT32 rd_i0(void)
{
    return adsp2100.i[0];
}
static INT32 rd_i1(void)
{
    return adsp2100.i[1];
}
static INT32 rd_i2(void)
{
    return adsp2100.i[2];
}
static INT32 rd_i3(void)
{
    return adsp2100.i[3];
}
static INT32 rd_i4(void)
{
    return adsp2100.i[4];
}
static INT32 rd_i5(void)
{
    return adsp2100.i[5];
}
static INT32 rd_i6(void)
{
    return adsp2100.i[6];
}
static INT32 rd_i7(void)
{
    return adsp2100.i[7];
}
static INT32 rd_m0(void)
{
    return adsp2100.m[0];
}
static INT32 rd_m1(void)
{
    return adsp2100.m[1];
}
static INT32 rd_m2(void)
{
    return adsp2100.m[2];
}
static INT32 rd_m3(void)
{
    return adsp2100.m[3];
}
static INT32 rd_m4(void)
{
    return adsp2100.m[4];
}
static INT32 rd_m5(void)
{
    return adsp2100.m[5];
}
static INT32 rd_m6(void)
{
    return adsp2100.m[6];
}
static INT32 rd_m7(void)
{
    return adsp2100.m[7];
}
static INT32 rd_l0(void)
{
    return adsp2100.l[0];
}
static INT32 rd_l1(void)
{
    return adsp2100.l[1];
}
static INT32 rd_l2(void)
{
    return adsp2100.l[2];
}
static INT32 rd_l3(void)
{
    return adsp2100.l[3];
}
static INT32 rd_l4(void)
{
    return adsp2100.l[4];
}
static INT32 rd_l5(void)
{
    return adsp2100.l[5];
}
static INT32 rd_l6(void)
{
    return adsp2100.l[6];
}
static INT32 rd_l7(void)
{
    return adsp2100.l[7];
}
static INT32 rd_astat(void)
{
    return adsp2100.astat;
}
static INT32 rd_mstat(void)
{
    return adsp2100.mstat;
}
static INT32 rd_sstat(void)
{
    return adsp2100.sstat;
}
static INT32 rd_imask(void)
{
    return adsp2100.imask;
}
static INT32 rd_icntl(void)
{
    return adsp2100.icntl;
}
static INT32 rd_cntr(void)
{
    return adsp2100.cntr;
}
static INT32 rd_sb(void)
{
    return core->sb.s;
}
static INT32 rd_px(void)
{
    return adsp2100.px;
}
#if SUPPORT_2101_EXTENSIONS
static INT32 rd_rx0(void)
{
    if (adsp2105_rx_callback) return (*adsp2105_rx_callback)(0);
    else return 0;
}
static INT32 rd_rx1(void)
{
    if (adsp2105_rx_callback) return (*adsp2105_rx_callback)(1);
    else return 0;
}
#endif
static INT32 rd_stacktop(void)
{
    return pc_stack_pop_val();
}
