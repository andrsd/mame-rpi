        ...
        case 0x02:
            ...
            if (op & 0x008000) {
                ...
                if (CONDITION(op & 15)) {
                    switch ((op >> 4) & 3) {
                    case 1:
                        adsp2100.flagout = !adsp2100.flagout;
                    case 2:
                        adsp2100.flagout = 0;
                    case 3:
                        adsp2100.flagout = 1;
...
unsigned adsp2100_get_reg(int regnum)
{
    ...
    case ADSP2100_MY1:
        return core->my1.u;
    case ADSP2100_MR0:
        return core->mr.mrx.mr0.u;
    case ADSP2100_MR1:
        return core->mr.mrx.mr1.u;
    case ADSP2100_MR2:
        return core->mr.mrx.mr2.u;
    case ADSP2100_MF:
        return core->mf.u;
    ...
    case ADSP2100_SB:
        return core->sb.u;
    case ADSP2100_SR0:
        return core->sr.srx.sr0.u;
    case ADSP2100_SR1:
        return core->sr.srx.sr1.u;
    ...
    case ADSP2100_PCSP:
        return adsp2100.pc_sp;
    case ADSP2100_CNTRSP:
        return adsp2100.cntr_sp;
    case ADSP2100_STATSP:
        return adsp2100.stat_sp;
    case ADSP2100_LOOPSP:
        return adsp2100.loop_sp;
    ...
    case ADSP2100_IRQSTATE0:
        return adsp2100.irq_state[0];
    case ADSP2100_IRQSTATE1:
        return adsp2100.irq_state[1];
    case ADSP2100_IRQSTATE2:
        return adsp2100.irq_state[2];
    case ADSP2100_IRQSTATE3:
        return adsp2100.irq_state[3];

    case ADSP2100_FLAGIN:
        return adsp2100.flagin;
    case ADSP2100_FLAGOUT:
        return adsp2100.flagout;
#if SUPPORT_2101_EXTENSIONS
    case ADSP2100_FL0:
        return adsp2100.fl0;
    case ADSP2100_FL1:
...
void adsp2100_set_reg(int regnum, unsigned val)
{
    ...
    case ADSP2100_PCSP:
        ...
        break;
    case ADSP2100_CNTRSP:
        adsp2100.cntr_sp = val;
        break;
    case ADSP2100_STATSP:
        adsp2100.stat_sp = val;
        break;
    case ADSP2100_LOOPSP:
        adsp2100.loop_sp = val;
        break;
    ...
    case ADSP2100_ICNTL:
        ...
        break;
    case ADSP2100_IRQSTATE0:
        adsp2100.irq_state[0] = val;
        break;
    case ADSP2100_IRQSTATE1:
        adsp2100.irq_state[1] = val;
        break;
    case ADSP2100_IRQSTATE2:
        adsp2100.irq_state[2] = val;
        break;
    case ADSP2100_IRQSTATE3:
        adsp2100.irq_state[3] = val;
        break;
...
const char *adsp2100_info(void *context, int regnum)
{
    ...
    case CPU_INFO_CREDITS:
        return "Copyright (C) Aaron Giles 1999";
    }
    return "";
}
...
int adsp2105_execute(int cycles)
{
    return adsp2100_execute(cycles);
}
unsigned adsp2105_get_context(void *dst)
{
    return adsp2100_get_context(dst);
}
void adsp2105_set_context(void *src)
{
    adsp2100_set_context(src);
}
unsigned adsp2105_get_pc(void)
{
    return adsp2100_get_pc();
}
void adsp2105_set_pc(unsigned val)
{
    adsp2100_set_pc(val);
}
unsigned adsp2105_get_sp(void)
{
    return adsp2100_get_sp();
}
void adsp2105_set_sp(unsigned val)
{
    adsp2100_set_sp(val);
}
unsigned adsp2105_get_reg(int regnum)
{
    return adsp2100_get_reg(regnum);
}
void adsp2105_set_reg(int regnum, unsigned val)
{
    adsp2100_set_reg(regnum, val);
}
void adsp2105_set_nmi_line(int state)
{
    adsp2100_set_nmi_line(state);
}
void adsp2105_set_irq_line(int irqline, int state)
{
    adsp2100_set_irq_line(irqline, state);
}
void adsp2105_set_irq_callback(int (*callback)(int irqline))
{
    adsp2100_set_irq_callback(callback);
}
