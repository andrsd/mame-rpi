...
OP(0x68, i_push_d16)
{
    ...
    FETCHWORD(tmp);
    PUSH(tmp);
    CLKW(12, 12, 5, 12, 8, 5, I.regs.w[SP]);
}
OP(0x69, i_imul_d16)
{
    UINT32 tmp;
...
OP(0x6a, i_push_d8)
{
    ...
    PUSH(tmp);
    CLKW(11, 11, 5, 11, 7, 3, I.regs.w[SP]);
}
OP(0x6b, i_imul_d8)
{
    UINT32 src2;
...
OP(0x8b, i_mov_r16w)
{
    ...
    src = GetRMWord(ModRM);
    RegWord(ModRM) = src;
    CLKR(15, 15, 7, 15, 11, 5, 2, EA);
}
OP(0x8c, i_mov_wsreg)
{
    GetModRM;
    PutRMWord(ModRM, I.sregs[(ModRM & 0x38) >> 3]);
    CLKR(14, 14, 5, 14, 10, 3, 2, EA);
}
OP(0x8d, i_lea)
{
    UINT16 ModRM = FETCH;
...
OP(0x9a, i_call_far)
{
    ...
    CHANGE_PC;
    CLKW(29, 29, 13, 29, 21, 9, I.regs.w[SP]);
}
OP(0x9b, i_wait) { }
OP(0x9c, i_pushf)
{
...
OP(0xe0, i_loopne)
{
    ...
    I.regs.w[CW]--;
    if (!ZF && I.regs.w[CW]) {
        I.ip = (WORD)(I.ip + disp); /*CHANGE_PC;*/ CLKS(14, 14, 6);
    } else CLKS(5, 5, 3);
}
OP(0xe1, i_loope)
{
...
OP(0xe2, i_loop)
{
    ...
    I.regs.w[CW]--;
    if (I.regs.w[CW]) {
        I.ip = (WORD)(I.ip + disp); /*CHANGE_PC;*/ CLKS(13, 13, 6);
    } else CLKS(5, 5, 3);
}
OP(0xe3, i_jcxz)
{
...
void nec_set_reg(int regnum, unsigned val)
{
    ...
    case NEC_PENDING:
        ...
        break;
    case NEC_NMI_STATE:
        nec_set_nmi_line(val);
        break;
    case NEC_IRQ_STATE:
        nec_set_irq_line(0, val);
        break;
    default:
        if (regnum <= REG_SP_CONTENTS) {
            unsigned offset = (((I.sregs[SS] << 4) + I.regs.w[SP])) + 2 * (REG_SP_CONTENTS - regnum);
...
unsigned v20_get_context(void *dst)
{
    return nec_get_context(dst);
}
void v20_set_context(void *src)
{
    nec_set_context(src);
}
unsigned v20_get_pc(void)
{
    return nec_get_pc();
}
void v20_set_pc(unsigned val)
{
    nec_set_pc(val);
}
unsigned v20_get_sp(void)
{
    return nec_get_sp();
}
void v20_set_sp(unsigned val)
{
    nec_set_sp(val);
}
unsigned v20_get_reg(int regnum)
{
    return nec_get_reg(regnum);
}
void v20_set_reg(int regnum, unsigned val)
{
    nec_set_reg(regnum, val);
}
void v20_set_nmi_line(int state)
{
    nec_set_nmi_line(state);
}
void v20_set_irq_line(int irqline, int state)
{
    nec_set_irq_line(irqline, state);
}
void v20_set_irq_callback(int (*callback)(int irqline))
{
...
const char *v20_info(void *context, int regnum)
{
    ...
    case CPU_INFO_CREDITS:
        return "NEC emulator v1.4 by Bryan McPhail";
    }
    return "";
}
unsigned v20_dasm(char *buffer, unsigned pc)
{
    return nec_dasm(buffer, pc);
}
...
unsigned v30_get_context(void *dst)
{
    return nec_get_context(dst);
}
void v30_set_context(void *src)
{
    nec_set_context(src);
}
unsigned v30_get_pc(void)
{
    return nec_get_pc();
}
void v30_set_pc(unsigned val)
{
    nec_set_pc(val);
}
unsigned v30_get_sp(void)
{
    return nec_get_sp();
}
void v30_set_sp(unsigned val)
{
    nec_set_sp(val);
}
unsigned v30_get_reg(int regnum)
{
    return nec_get_reg(regnum);
}
void v30_set_reg(int regnum, unsigned val)
{
    nec_set_reg(regnum, val);
}
void v30_set_nmi_line(int state)
{
    nec_set_nmi_line(state);
}
void v30_set_irq_line(int irqline, int state)
{
    nec_set_irq_line(irqline, state);
}
void v30_set_irq_callback(int (*callback)(int irqline))
{
    nec_set_irq_callback(callback);
}
...
unsigned v33_get_context(void *dst)
{
    return nec_get_context(dst);
}
void v33_set_context(void *src)
{
    nec_set_context(src);
}
unsigned v33_get_pc(void)
{
    return nec_get_pc();
}
void v33_set_pc(unsigned val)
{
    nec_set_pc(val);
}
unsigned v33_get_sp(void)
{
    return nec_get_sp();
}
void v33_set_sp(unsigned val)
{
    nec_set_sp(val);
}
unsigned v33_get_reg(int regnum)
{
    return nec_get_reg(regnum);
}
void v33_set_reg(int regnum, unsigned val)
{
    nec_set_reg(regnum, val);
}
void v33_set_nmi_line(int state)
{
    nec_set_nmi_line(state);
}
void v33_set_irq_line(int irqline, int state)
{
    nec_set_irq_line(irqline, state);
}
void v33_set_irq_callback(int (*callback)(int irqline))
{
    nec_set_irq_callback(callback);
}
...
unsigned v33_dasm(char *buffer, unsigned pc)
{
    return nec_dasm(buffer, pc);
}
