...
unsigned drz80_get_reg(int regnum)
{
    ...
    case Z80_SP:
        return drz80_get_sp();
    case Z80_AF:
        return ((DRZ80.regs.Z80A >> 16) | (DRZ80.regs.Z80F >> 24));
    case Z80_BC:
        return (DRZ80.regs.Z80BC >> 16);
    case Z80_DE:
        return (DRZ80.regs.Z80DE >> 16);
    case Z80_HL:
        return (DRZ80.regs.Z80HL >> 16);
    case Z80_IX:
        return (DRZ80.regs.Z80IX >> 16);
    case Z80_IY:
        return (DRZ80.regs.Z80IY >> 16);
    case Z80_R:
        return DRZ80.regs.Z80R; /*???*/
    case Z80_I:
        return DRZ80.regs.Z80I;
    case Z80_AF2:
        return ((DRZ80.regs.Z80A2 >> 16) | (DRZ80.regs.Z80F2 >> 24));
    case Z80_BC2:
        return (DRZ80.regs.Z80BC2 >> 16);
    case Z80_DE2:
        return (DRZ80.regs.Z80DE2 >> 16);
    case Z80_HL2:
        return (DRZ80.regs.Z80HL2 >> 16);
    case Z80_IM:
        return DRZ80.regs.Z80IM;
    case Z80_IFF1:
        return ((DRZ80.regs.Z80IF & 1) != 0);
    case Z80_IFF2:
        return ((DRZ80.regs.Z80IF & 2) != 0);
    case Z80_HALT:
        return ((DRZ80.regs.Z80IF & 4) != 0);
    case Z80_NMI_STATE:
        return DRZ80.nmi_state;
    case Z80_IRQ_STATE:
        return DRZ80.irq_state;
    case Z80_DC0:
        return 0; /* daisy chain */
    case Z80_DC1:
        return 0; /* daisy chain */
    case Z80_DC2:
        return 0; /* daisy chain */
    case Z80_DC3:
        return 0; /* daisy chain */
    case REG_PREVIOUSPC:
        return (DRZ80.previouspc == 0xffffffff ? 0xffffffff : drz80_get_pc());
    default:
...
void drz80_set_reg(int regnum, unsigned val)
{
    ...
    case Z80_SP:
        ...
        break;
    case Z80_AF:
        DRZ80.regs.Z80A = ((val & 0xff00) << 16);
        DRZ80.regs.Z80F = ((val & 0x00ff) << 24);
        break;
    case Z80_BC:
        DRZ80.regs.Z80BC = (val << 16);
        break;
    case Z80_DE:
        DRZ80.regs.Z80DE = (val << 16);
        break;
    case Z80_HL:
        DRZ80.regs.Z80HL = (val << 16);
        break;
    case Z80_IX:
        DRZ80.regs.Z80IX = (val << 16);
        break;
    case Z80_IY:
        DRZ80.regs.Z80IY = (val << 16);
        break;
    case Z80_R:
        DRZ80.regs.Z80R = val;
        break; /*???*/
    case Z80_I:
        ...
        break;
    case Z80_AF2:
        DRZ80.regs.Z80A2 = ((val & 0xff00) << 16);
        DRZ80.regs.Z80F2 = ((val & 0x00ff) << 24);
        break;
    case Z80_BC2:
        DRZ80.regs.Z80BC2 = (val << 16);
        break;
    case Z80_DE2:
        DRZ80.regs.Z80DE2 = (val << 16);
        break;
    case Z80_HL2:
        DRZ80.regs.Z80HL2 = (val << 16);
        break;
    case Z80_IM:
        DRZ80.regs.Z80IM = val;
        break;
    case Z80_IFF1:
        DRZ80.regs.Z80IF = (DRZ80.regs.Z80IF) & (~(val == 0));
        break;
    case Z80_IFF2:
        DRZ80.regs.Z80IF = (DRZ80.regs.Z80IF) & (~((val == 0) << 1));
        break;
    case Z80_HALT:
        DRZ80.regs.Z80IF = (DRZ80.regs.Z80IF) & (~((val == 0) << 2));
        break;
    case Z80_NMI_STATE:
        drz80_set_nmi_line(val);
        break;
    case Z80_IRQ_STATE:
        drz80_set_irq_line(0, val);
        break;
    case Z80_DC0:
        break; /* daisy chain */
    case Z80_DC1:
...
const char *drz80_info(void *context, int regnum)
{
    ...
    case CPU_INFO_CREDITS:
        return "Copyright 2005 Reesy, all rights reserved.";
    }
    return "";
}
