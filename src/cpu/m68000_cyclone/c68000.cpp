...
unsigned cyclone_get_reg(int regnum)
{
    switch (regnum) {
    case M68K_PC:
        return cyclone_get_pc();
    case M68K_SP:
        return cyclone_get_sp();
    case M68K_ISP:
        return cyclone.regs.osp;
    case M68K_USP:
        return cyclone.regs.osp;
    case M68K_SR:
        return CycloneGetSr(&cyclone.regs);
    case M68K_D0:
        return cyclone.regs.d[0];
    case M68K_D1:
        return cyclone.regs.d[1];
    case M68K_D2:
        return cyclone.regs.d[2];
    case M68K_D3:
        return cyclone.regs.d[3];
    case M68K_D4:
        return cyclone.regs.d[4];
    case M68K_D5:
        return cyclone.regs.d[5];
    case M68K_D6:
        return cyclone.regs.d[6];
    case M68K_D7:
        return cyclone.regs.d[7];
    case M68K_A0:
        return cyclone.regs.a[0];
    case M68K_A1:
        return cyclone.regs.a[1];
    case M68K_A2:
        return cyclone.regs.a[2];
    case M68K_A3:
        return cyclone.regs.a[3];
    case M68K_A4:
        return cyclone.regs.a[4];
    case M68K_A5:
        return cyclone.regs.a[5];
    case M68K_A6:
        return cyclone.regs.a[6];
    case M68K_A7:
        return cyclone.regs.a[7];
    case M68K_PREF_ADDR:
        return 0; /*?*/
    case M68K_PREF_DATA:
        return 0; /*?*/
    case REG_PREVIOUSPC:
        return (cyclone.regs.prev_pc - cyclone.regs.membase - 2) & 0xffffff;
    default:
...
void cyclone_set_reg(int regnum, unsigned val)
{
    ...
    case M68K_SP:
        ...
        break;
    case M68K_ISP:
        cyclone.regs.osp = val;
        break;
    case M68K_USP:
        cyclone.regs.osp = val;
        break;
    case M68K_SR:
        CycloneSetSr(&cyclone.regs, val);
        break;
    case M68K_D0:
        cyclone.regs.d[0] = val;
        break;
    case M68K_D1:
        cyclone.regs.d[1] = val;
        break;
    case M68K_D2:
        cyclone.regs.d[2] = val;
        break;
    case M68K_D3:
        cyclone.regs.d[3] = val;
        break;
    case M68K_D4:
        cyclone.regs.d[4] = val;
        break;
    case M68K_D5:
        cyclone.regs.d[5] = val;
        break;
    case M68K_D6:
        cyclone.regs.d[6] = val;
        break;
    case M68K_D7:
        cyclone.regs.d[7] = val;
        break;
    case M68K_A0:
        cyclone.regs.a[0] = val;
        break;
    case M68K_A1:
        cyclone.regs.a[1] = val;
        break;
    case M68K_A2:
        cyclone.regs.a[2] = val;
        break;
    case M68K_A3:
        cyclone.regs.a[3] = val;
        break;
    case M68K_A4:
        cyclone.regs.a[4] = val;
        break;
    case M68K_A5:
        cyclone.regs.a[5] = val;
        break;
    case M68K_A6:
        cyclone.regs.a[6] = val;
        break;
    case M68K_A7:
        cyclone.regs.a[7] = val;
        break;
...
const char *cyclone_info(void *context, int regnum)
{
    ...
    case CPU_INFO_CREDITS:
        return "Copyright Copyright 2004-2007 Dave, Reesy and Notaz. All rights reserved";
    }
    return "";
}
