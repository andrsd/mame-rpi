...
unsigned m4510_get_reg(int regnum)
{
    ...
    case M4510_ZP:
        return m4510.zp.b.l;
    case M4510_NMI_STATE:
        return m4510.nmi_state;
    case M4510_IRQ_STATE:
        return m4510.irq_state;
    case REG_PREVIOUSPC:
        return m4510.ppc.w.l;
    default:
...
void m4510_set_reg(int regnum, unsigned val)
{
    ...
    case M4510_ZP:
        ...
        break;
    case M4510_NMI_STATE:
        m4510_set_nmi_line(val);
        break;
    case M4510_IRQ_STATE:
        m4510_set_irq_line(0, val);
        break;
    default:
        if (regnum <= REG_SP_CONTENTS) {
            unsigned offset = S + 2 * (REG_SP_CONTENTS - regnum);
