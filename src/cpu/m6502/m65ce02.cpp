...
unsigned m65ce02_get_reg(int regnum)
{
    switch (regnum) {
    case M65CE02_PC:
        return m65ce02.pc.w.l;
    case M65CE02_S:
        return m65ce02.sp.w.l;
    case M65CE02_P:
        return m65ce02.p;
    case M65CE02_A:
        return m65ce02.a;
    ...
    case M65CE02_Z:
        return m65ce02.z;
    case M65CE02_B:
        return m65ce02.zp.b.h;
    case M65CE02_EA:
        return m65ce02.ea.w.l;
    case M65CE02_ZP:
        return m65ce02.zp.b.l;
    case M65CE02_NMI_STATE:
        return m65ce02.nmi_state;
    case M65CE02_IRQ_STATE:
        return m65ce02.irq_state;
    case REG_PREVIOUSPC:
        return m65ce02.ppc.w.l;
    default:
...
void m65ce02_set_reg(int regnum, unsigned val)
{
    ...
    case M65CE02_ZP:
        ...
        break;
    case M65CE02_NMI_STATE:
        m65ce02_set_nmi_line(val);
        break;
    case M65CE02_IRQ_STATE:
        m65ce02_set_irq_line(0, val);
        break;
    default:
        if (regnum <= REG_SP_CONTENTS) {
            unsigned offset = S + 2 * (REG_SP_CONTENTS - regnum);
...
const char *m65ce02_info(void *context, int regnum)
{
    ...
    case CPU_INFO_FAMILY:
        return "CBM Semiconductor Group CSG 65CE02";
