...
unsigned m6502_get_reg(int regnum)
{
    ...
    case M6502_ZP:
        return m6502.zp.w.l;
    case M6502_NMI_STATE:
        return m6502.nmi_state;
    case M6502_IRQ_STATE:
        return m6502.irq_state;
    case M6502_SO_STATE:
        return m6502.so_state;
    case M6502_SUBTYPE:
        return m6502.subtype;
    case REG_PREVIOUSPC:
        return m6502.ppc.w.l;
    default:
...
void m6502_set_reg(int regnum, unsigned val)
{
    ...
    case M6502_ZP:
        ...
        break;
    case M6502_NMI_STATE:
        m6502_set_nmi_line(val);
        break;
    case M6502_IRQ_STATE:
        m6502_set_irq_line(0, val);
        break;
    case M6502_SO_STATE:
        m6502_set_irq_line(M6502_SET_OVERFLOW, val);
        break;
    default:
        if (regnum <= REG_SP_CONTENTS) {
            unsigned offset = S + 2 * (REG_SP_CONTENTS - regnum);
...
unsigned m65c02_get_context(void *dst)
{
    return m6502_get_context(dst);
}
void m65c02_set_context(void *src)
{
    m6502_set_context(src);
}
unsigned m65c02_get_pc(void)
{
    return m6502_get_pc();
}
void m65c02_set_pc(unsigned val)
{
    m6502_set_pc(val);
}
unsigned m65c02_get_sp(void)
{
    return m6502_get_sp();
}
void m65c02_set_sp(unsigned val)
{
    m6502_set_sp(val);
}
unsigned m65c02_get_reg(int regnum)
{
    return m6502_get_reg(regnum);
}
void m65c02_set_reg(int regnum, unsigned val)
{
    m6502_set_reg(regnum, val);
}
...
void m65c02_set_irq_callback(int (*callback)(int irqline))
{
    m6502_set_irq_callback(callback);
}
void m65c02_state_save(void *file)
{
    m6502_state_save(file);
}
void m65c02_state_load(void *file)
{
    m6502_state_load(file);
}
...
void m65sc02_exit(void)
{
    m6502_exit();
}
int  m65sc02_execute(int cycles)
{
    return m65c02_execute(cycles);
}
unsigned m65sc02_get_context(void *dst)
{
    return m6502_get_context(dst);
}
void m65sc02_set_context(void *src)
{
    m6502_set_context(src);
}
unsigned m65sc02_get_pc(void)
{
    return m6502_get_pc();
}
void m65sc02_set_pc(unsigned val)
{
    m6502_set_pc(val);
}
unsigned m65sc02_get_sp(void)
{
    return m6502_get_sp();
}
void m65sc02_set_sp(unsigned val)
{
    m6502_set_sp(val);
}
unsigned m65sc02_get_reg(int regnum)
{
    return m6502_get_reg(regnum);
}
void m65sc02_set_reg(int regnum, unsigned val)
{
    m6502_set_reg(regnum, val);
}
void m65sc02_set_nmi_line(int state)
{
    m6502_set_nmi_line(state);
}
void m65sc02_set_irq_line(int irqline, int state)
{
    m6502_set_irq_line(irqline, state);
}
void m65sc02_set_irq_callback(int (*callback)(int irqline))
{
    m6502_set_irq_callback(callback);
}
void m65sc02_state_save(void *file)
{
    m6502_state_save(file);
}
void m65sc02_state_load(void *file)
{
    m6502_state_load(file);
}
const char *m65sc02_info(void *context, int regnum)
{
    ...
    case CPU_INFO_NAME:
        return "M65SC02";
    case CPU_INFO_FAMILY:
        return "Metal Oxid Semiconductor MOS 6502";
    case CPU_INFO_VERSION:
        return "1.0beta";
    case CPU_INFO_CREDITS:
...
void n2a03_exit(void)
{
    m6502_exit();
}
int  n2a03_execute(int cycles)
{
    return m65c02_execute(cycles);
}
unsigned n2a03_get_context(void *dst)
{
    return m6502_get_context(dst);
}
void n2a03_set_context(void *src)
{
    m6502_set_context(src);
}
unsigned n2a03_get_pc(void)
{
    return m6502_get_pc();
}
void n2a03_set_pc(unsigned val)
{
    m6502_set_pc(val);
}
unsigned n2a03_get_sp(void)
{
    return m6502_get_sp();
}
void n2a03_set_sp(unsigned val)
{
    m6502_set_sp(val);
}
unsigned n2a03_get_reg(int regnum)
{
    return m6502_get_reg(regnum);
}
void n2a03_set_reg(int regnum, unsigned val)
{
    m6502_set_reg(regnum, val);
}
void n2a03_set_nmi_line(int state)
{
    m6502_set_nmi_line(state);
}
void n2a03_set_irq_line(int irqline, int state)
{
    m6502_set_irq_line(irqline, state);
}
void n2a03_set_irq_callback(int (*callback)(int irqline))
{
    m6502_set_irq_callback(callback);
}
void n2a03_state_save(void *file)
{
    m6502_state_save(file);
}
void n2a03_state_load(void *file)
{
    m6502_state_load(file);
}
...
void m6510_exit(void)
{
    m6502_exit();
}
int  m6510_execute(int cycles)
{
    return m6502_execute(cycles);
}
unsigned m6510_get_context(void *dst)
{
    return m6502_get_context(dst);
}
void m6510_set_context(void *src)
{
    m6502_set_context(src);
}
unsigned m6510_get_pc(void)
{
    return m6502_get_pc();
}
void m6510_set_pc(unsigned val)
{
    m6502_set_pc(val);
}
unsigned m6510_get_sp(void)
{
    return m6502_get_sp();
}
void m6510_set_sp(unsigned val)
{
    m6502_set_sp(val);
}
unsigned m6510_get_reg(int regnum)
{
    return m6502_get_reg(regnum);
}
void m6510_set_reg(int regnum, unsigned val)
{
    m6502_set_reg(regnum, val);
}
void m6510_set_nmi_line(int state)
{
    m6502_set_nmi_line(state);
}
void m6510_set_irq_line(int irqline, int state)
{
    m6502_set_irq_line(irqline, state);
}
void m6510_set_irq_callback(int (*callback)(int irqline))
{
    m6502_set_irq_callback(callback);
}
void m6510_state_save(void *file)
{
    m6502_state_save(file);
}
void m6510_state_load(void *file)
{
    m6502_state_load(file);
}
