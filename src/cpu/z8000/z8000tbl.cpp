...
static Z8000_init table[] = {
    ...
    {0x1f10, 0x1ff0, 16, 1, 10, Z1F_ddN0_0000,							 "call    %rw2"},
    ...
    {0x5f00, 0x5f00, 1, 2, 12, Z5F_0000_0000_addr, 					 "call    %a1"},
    {0x5f10, 0x5ff0, 16, 2, 13, Z5F_ddN0_0000_addr, 					 "call    %a1(%rw2)"},
    ...
    {0x7a00, 0x7a00, 1, 1,  8, Z7A_0000_0000,							 "halt"},
    {0x7b00, 0x7b00, 1, 1, 13, Z7B_0000_0000,							 "iret"},
    ...
    {0x9e00, 0x9e0f, 1, 1, 10, Z9E_0000_cccc,							 "ret     %c3"},
    ...
    {0xba11, 0xbaf1, 16, 2, 11, ZBA_ssN0_0001_0000_rrrr_ddN0_x000,		 "ldirb   @%rw6,@%rw2,rr"},
    {0xba12, 0xbaf2, 16, 2, 11, ZBA_ssN0_0010_0000_rrrr_ddN0_cccc,		 "cpsib   @%rw6,@%rw2,rr,%c7"},
    {0xba14, 0xbaf4, 16, 2, 11, ZBA_ssN0_0100_0000_rrrr_dddd_cccc,		 "cpirb   %rb6,@%rw2,rr,%c7"},
    {0xba16, 0xbaf6, 16, 2, 11, ZBA_ssN0_0110_0000_rrrr_ddN0_cccc,		 "cpsirb  @%rw6,@%rw2,rr,%c7"},
    {0xba18, 0xbaf8, 16, 2, 11, ZBA_ssN0_1000_0000_rrrr_dddd_cccc,		 "cpdb    %rb6,@%rw2,rr,%c7"},
    {0xba19, 0xbaf9, 16, 2, 11, ZBA_ssN0_1001_0000_rrrr_ddN0_x000,		 "lddrb   @%rw2,@%rw6,rr"},
    {0xba1a, 0xbafa, 16, 2, 11, ZBA_ssN0_1010_0000_rrrr_ddN0_cccc,		 "cpsdb   @%rw6,@%rw2,rr,%c7"},
    {0xba1c, 0xbafc, 16, 2, 11, ZBA_ssN0_1100_0000_rrrr_dddd_cccc,		 "cpdrb   %rb6,@%rw2,rr,%c7"},
    {0xba1e, 0xbafe, 16, 2, 11, ZBA_ssN0_1110_0000_rrrr_ddN0_cccc,		 "cpsdrb  @%rw6,@%rw2,rr,%c7"},
    {0xbb10, 0xbbf0, 16, 2, 11, ZBB_ssN0_0000_0000_rrrr_dddd_cccc,		 "cpi     %rw6,@%rw2,rr,%c7"},
    {0xbb11, 0xbbf1, 16, 2, 11, ZBB_ssN0_0001_0000_rrrr_ddN0_x000,		 "ldir    @%rw6,@%rw2,rr"},
    {0xbb12, 0xbbf2, 16, 2, 11, ZBB_ssN0_0010_0000_rrrr_ddN0_cccc,		 "cpsi    @%rw6,@%rw2,rr,%c7"},
    {0xbb14, 0xbbf4, 16, 2, 11, ZBB_ssN0_0100_0000_rrrr_dddd_cccc,		 "cpir    %rw6,@%rw2,rr,%c7"},
    {0xbb16, 0xbbf6, 16, 2, 11, ZBB_ssN0_0110_0000_rrrr_ddN0_cccc,		 "cpsir   @%rw6,@%rw2,rr,%c7"},
    {0xbb18, 0xbbf8, 16, 2, 11, ZBB_ssN0_1000_0000_rrrr_dddd_cccc,		 "cpd     %rw6,@%rw2,rr,%c7"},
    {0xbb19, 0xbbf9, 16, 2, 11, ZBB_ssN0_1001_0000_rrrr_ddN0_x000,		 "lddr    @%rw2,@%rw6,rr"},
    {0xbb1a, 0xbbfa, 16, 2, 11, ZBB_ssN0_1010_0000_rrrr_ddN0_cccc,		 "cpsd    @%rw6,@%rw2,rr,%c7"},
    {0xbb1c, 0xbbfc, 16, 2, 11, ZBB_ssN0_1100_0000_rrrr_dddd_cccc,		 "cpdr    %rw6,@%rw2,rr,%c7"},
    {0xbb1e, 0xbbfe, 16, 2, 11, ZBB_ssN0_1110_0000_rrrr_ddN0_cccc,		 "cpsdr   @%rw6,@%rw2,rr,%c7"},
    ...
    {0xd000, 0xdfff, 1, 1, 10, ZD_dsp12,								 "calr    %d2"},
    {0xe000, 0xefff, 1, 1,  6, ZE_cccc_dsp8,							 "jr      %c1,%d1"},
    {0xf000, 0xf07f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf100, 0xf17f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf200, 0xf27f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf300, 0xf37f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf400, 0xf47f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf500, 0xf57f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf600, 0xf67f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf700, 0xf77f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf800, 0xf87f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf900, 0xf97f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xfa00, 0xfa7f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xfb00, 0xfb7f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xfc00, 0xfc7f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xfd00, 0xfd7f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xfe00, 0xfe7f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xff00, 0xff7f, 1, 1, 11, ZF_dddd_0dsp7,							 "dbjnz   %rb1,%d0"},
    {0xf080, 0xf0ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf180, 0xf1ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf280, 0xf2ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf380, 0xf3ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf480, 0xf4ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf580, 0xf5ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf680, 0xf6ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf780, 0xf7ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf880, 0xf8ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xf980, 0xf9ff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xfa80, 0xfaff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xfb80, 0xfbff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xfc80, 0xfcff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xfd80, 0xfdff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xfe80, 0xfeff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0xff80, 0xffff, 1, 1, 11, ZF_dddd_1dsp7,							 "djnz    %rw1,%d0"},
    {0, 	0,	   0,	0,	0, 0,									 0},
};
