...
/* Pixel operations */
static UINT16 pixel_op00(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return srcpix;
}
static UINT16 pixel_op01(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return srcpix & dstpix;
}
static UINT16 pixel_op02(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return srcpix & ~dstpix;
}
static UINT16 pixel_op03(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return 0;
}
static UINT16 pixel_op04(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (srcpix | ~dstpix) & mask;
}
static UINT16 pixel_op05(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return ~(srcpix ^ dstpix) & mask;
}
static UINT16 pixel_op06(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return ~dstpix & mask;
}
static UINT16 pixel_op07(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return ~(srcpix | dstpix) & mask;
}
static UINT16 pixel_op08(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (srcpix | dstpix) & mask;
}
static UINT16 pixel_op09(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return dstpix & mask;
}
static UINT16 pixel_op10(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (srcpix ^ dstpix) & mask;
}
static UINT16 pixel_op11(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (~srcpix & dstpix) & mask;
}
static UINT16 pixel_op12(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return mask;
}
static UINT16 pixel_op13(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (~srcpix & dstpix) & mask;
}
static UINT16 pixel_op14(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return ~(srcpix & dstpix) & mask;
}
static UINT16 pixel_op15(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return srcpix ^ mask;
}
static UINT16 pixel_op16(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (srcpix + dstpix) & mask;
}
static UINT16 pixel_op17(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    INT32 tmp = srcpix + (dstpix & mask);
    return (tmp > mask) ? mask : tmp;
}
static UINT16 pixel_op18(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    return (dstpix - srcpix) & mask;
}
static UINT16 pixel_op19(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    INT32 tmp = srcpix - (dstpix & mask);
    return (tmp < 0) ? 0 : tmp;
}
static UINT16 pixel_op20(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    dstpix &= mask;
    return (srcpix > dstpix) ? srcpix : dstpix;
}
static UINT16 pixel_op21(UINT16 dstpix, UINT16 mask, UINT16 srcpix)
{
    dstpix &= mask;
    return (srcpix < dstpix) ? srcpix : dstpix;
}
