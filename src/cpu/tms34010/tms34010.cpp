...
static READ_HANDLER(read_pixel_1)
{
    RP(0x0f, 0x01)
}
static READ_HANDLER(read_pixel_2)
{
    RP(0x0e, 0x03)
}
static READ_HANDLER(read_pixel_4)
{
    RP(0x0c, 0x0f)
}
static READ_HANDLER(read_pixel_8)
{
    RP(0x08, 0xff)
}
...
/* No Raster Op + No Transparency */
static WRITE_HANDLER(write_pixel_1)
{
    WP(0x0f, 0x01);
}
static WRITE_HANDLER(write_pixel_2)
{
    WP(0x0e, 0x03);
}
static WRITE_HANDLER(write_pixel_4)
{
    WP(0x0c, 0x0f);
}
static WRITE_HANDLER(write_pixel_8)
{
    WP(0x08, 0xff);
}
...
/* No Raster Op + Transparency */
static WRITE_HANDLER(write_pixel_t_1)
{
    WP_T(0x0f, 0x01);
}
static WRITE_HANDLER(write_pixel_t_2)
{
    WP_T(0x0e, 0x03);
}
static WRITE_HANDLER(write_pixel_t_4)
{
    WP_T(0x0c, 0x0f);
}
static WRITE_HANDLER(write_pixel_t_8)
{
    WP_T(0x08, 0xff);
}
...
/* Raster Op + No Transparency */
static WRITE_HANDLER(write_pixel_r_1)
{
    WP_R(0x0f, 0x01);
}
static WRITE_HANDLER(write_pixel_r_2)
{
    WP_R(0x0e, 0x03);
}
static WRITE_HANDLER(write_pixel_r_4)
{
    WP_R(0x0c, 0x0f);
}
static WRITE_HANDLER(write_pixel_r_8)
{
    WP_R(0x08, 0xff);
}
...
/* Raster Op + Transparency */
static WRITE_HANDLER(write_pixel_r_t_1)
{
    WP_R_T(0x0f, 0x01);
}
static WRITE_HANDLER(write_pixel_r_t_2)
{
    WP_R_T(0x0e, 0x03);
}
static WRITE_HANDLER(write_pixel_r_t_4)
{
    WP_R_T(0x0c, 0x0f);
}
static WRITE_HANDLER(write_pixel_r_t_8)
{
    WP_R_T(0x08, 0xff);
}
...
{
    return (oldpix > newpix) ? oldpix - newpix : 0;
}
...
unsigned tms34010_get_reg(int regnum)
{
    ...
    case TMS34010_A14:
        return AREG(14);
    case TMS34010_B0:
        return BREG(BINDEX(0));
    case TMS34010_B1:
        return BREG(BINDEX(1));
    case TMS34010_B2:
        return BREG(BINDEX(2));
    case TMS34010_B3:
        return BREG(BINDEX(3));
    case TMS34010_B4:
        return BREG(BINDEX(4));
    case TMS34010_B5:
        return BREG(BINDEX(5));
    case TMS34010_B6:
        return BREG(BINDEX(6));
    case TMS34010_B7:
        return BREG(BINDEX(7));
    case TMS34010_B8:
        return BREG(BINDEX(8));
    case TMS34010_B9:
        return BREG(BINDEX(9));
    case TMS34010_B10:
        return BREG(BINDEX(10));
    case TMS34010_B11:
        return BREG(BINDEX(11));
    case TMS34010_B12:
        return BREG(BINDEX(12));
    case TMS34010_B13:
        return BREG(BINDEX(13));
    case TMS34010_B14:
        return BREG(BINDEX(14));
...
const char *tms34010_info(void *context, int regnum)
{
    ...
    case CPU_INFO_FAMILY:
        return "Texas Instruments 34010";
    case CPU_INFO_VERSION:
        return "1.0";
    case CPU_INFO_FILE:
        return __FILE__;
    case CPU_INFO_CREDITS:
        return "Copyright (C) Alex Pasadyn/Zsolt Vasvari 1998\nParts based on code by Aaron Giles";
    }
    return "";
}
...
const char *tms34020_info(void *context, int regnum)
{
    ...
    case CPU_INFO_NAME:
        return "TMS34020";
    case CPU_INFO_FAMILY:
        return "Texas Instruments 34020";
    default:
        return tms34010_info(context, regnum);
    }
}
...
static void common_io_register_w(int cpunum, tms34010_regs *context, int reg, int data)
{
    ...
    case REG_PSIZE:
        ...
        default:
        case 0x01:
            context->xytolshiftcount2 = 0;
            break;
        case 0x02:
            context->xytolshiftcount2 = 1;
            break;
        case 0x04:
            context->xytolshiftcount2 = 2;
            break;
        case 0x08:
            context->xytolshiftcount2 = 3;
            break;
        case 0x10:
            context->xytolshiftcount2 = 4;
            break;
        }
        break;
