...
READ_HANDLER(twincobr_dsp_r)
{
    ...
    case 0x30000:
        ...
        break;
    case 0x40000:
        input_data = READ_WORD(&spriteram[dsp_addr_w]);
        break;
    case 0x50000:
        input_data = READ_WORD(&paletteram[dsp_addr_w]);
        break;
    case 0x7000:
        input_data = wardner_mainram[dsp_addr_w] + (wardner_mainram[dsp_addr_w + 1] << 8);
        break;
    case 0x8000:
        input_data = spriteram[dsp_addr_w] + (spriteram[dsp_addr_w + 1] << 8);
        break;
    case 0xa000:
        input_data = paletteram[dsp_addr_w] + (paletteram[dsp_addr_w + 1] << 8);
        break;
...
WRITE_HANDLER(twincobr_dsp_w)
{
    ...
    if (offset == 1) {
        ...
        case 0x30000:
            ...
            break;
        case 0x40000:
            WRITE_WORD(&spriteram[dsp_addr_w], data);
            break;
        case 0x50000:
            WRITE_WORD(&paletteram[dsp_addr_w], data);
            break;
        case 0x7000:
            wardner_mainram[dsp_addr_w] = data & 0xff;
            wardner_mainram[dsp_addr_w + 1] = (data >> 8) & 0xff;
            if ((dsp_addr_w < 3) && (data == 0)) dsp_execute = 1;
            break;
        case 0x8000:
            spriteram[dsp_addr_w] = data & 0xff;
            spriteram[dsp_addr_w + 1] = (data >> 8) & 0xff;
            break;
        case 0xa000:
            paletteram[dsp_addr_w] = data & 0xff;
            paletteram[dsp_addr_w + 1] = (data >> 8) & 0xff;
            break;
