...
void UPD7759_message_w(int num, int data)
{
    ...
    if (upd7759_intf->mode == UPD7759_SLAVE_MODE) {
        ...
        case 0x1c:
            offset = 0x28000;
            break;	/* roms 0x8000 in size in size */
        ...
        case 0x08:
            offset = 0x30000;
            break; /* roms 0x10000 & 0x20000 in size */
        case 0x09:
            offset = 0x34000;
            break; /* roms 0x10000 & 0x20000 in size */
        case 0x0a:
...
{
    return UPD7759_data_r(0, offset);
}
READ_HANDLER(UPD7759_1_data_r)
{
    return UPD7759_data_r(1, offset);
}
