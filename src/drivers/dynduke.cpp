...
static READ_HANDLER(dynduke_shared_r)
{
    return dynduke_shared_ram[offset];
}
static WRITE_HANDLER(dynduke_shared_w)
{
    dynduke_shared_ram[offset] = data;
}
...
static READ_HANDLER(dynduke_soundcpu_r)
{
    ...
    switch (offset) {
    case 0x04: {
        erg = seibu_shared_sound_ram[6];  /* just 1 time */
        seibu_shared_sound_ram[6] = 0;
        break;
    }
    case 0x06: {
        erg = 0xa0;
    ...
    default:
        erg = seibu_shared_sound_ram[offset];
    }
    return erg;
}
