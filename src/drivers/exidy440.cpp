...
static void init_crossbow(void)
{
    SET_PARAMS(0, 0x00, 0x00, 0x00, 0, 0, 0x00);
}
static void init_cheyenne(void)
{
    SET_PARAMS(0, 0xff, 0x00, 0x00, 0, 0, 0x00);
}
static void init_combat(void)
{
    SET_PARAMS(0, 0xff, 0xff, 0x00, 0, 0, 0x00);
}
static void init_cracksht(void)
{
    SET_PARAMS(0, 0xff, 0xff, 0x04, 0, 0, 0x00);
}
static void init_claypign(void)
{
    SET_PARAMS(0, 0xff, 0xff, 0x04, 0, 0, 0x76);
}
static void init_chiller(void)
{
    SET_PARAMS(0, 0xff, 0xff, 0x04, 0, 0, 0x00);
}
static void init_topsecex(void)
{
    SET_PARAMS(1, 0xff, 0xff, 0x04, 0, 0, 0x00);
}
static void init_hitnmiss(void)
{
    SET_PARAMS(0, 0xff, 0xff, 0x04, 0, 1, 0x00);
}
static void init_whodunit(void)
{
    SET_PARAMS(0, 0xff, 0xff, 0x04, 1, 0, 0x00);
}
