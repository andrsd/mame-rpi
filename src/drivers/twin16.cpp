...
static READ_HANDLER(twin16_input_r)
{
    switch (offset) {
    case 0x00:
        return readinputport(0);    // coin
    case 0x02:
        return readinputport(1);    // p1
    case 0x04:
        return readinputport(2);    // p2
    case 0x06:
        return readinputport(3);    // p3? (Devils World)
    case 0x10:
        return readinputport(5);    // DSW1
    case 0x12:
        return readinputport(4);    // DSW2
    case 0x18:
        return readinputport(6);    // DSW3
    }
    return 0;
}
