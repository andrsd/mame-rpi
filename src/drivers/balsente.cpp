...
static void init_sentetst(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0; /* noanalog */
}
static void init_cshift(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0; /* noanalog */
}
static void init_gghost(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0;
    adc_shift = 1;
}
static void init_hattrick(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0; /* noanalog */
}
static void init_otwalls(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0;
    adc_shift = 0;
}
static void init_snakepit(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0;
    adc_shift = 1;
}
static void init_snakjack(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0;
    adc_shift = 1;
}
static void init_stocker(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0;
    adc_shift = 0;
}
static void init_triviag1(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0; /* noanalog */
}
...
static void init_gimeabrk(void)
{
    expand_roms(EXPAND_ALL);
    balsente_shooter = 0;
    adc_shift = 1;
}
static void init_minigolf(void)
{
    expand_roms(0x0c);
    balsente_shooter = 0;
    adc_shift = 2;
}
static void init_minigol2(void)
{
    expand_roms(EXPAND_NONE);
    balsente_shooter = 0;
    adc_shift = 2;
...
static void init_rescraid(void)
{
    expand_roms(EXPAND_NONE);
    balsente_shooter = 0; /* noanalog */
}
