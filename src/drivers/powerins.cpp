...
READ_HANDLER(powerins_input_r)
{
    switch (offset) {
    case 0x00:
        return readinputport(1);		// Coins + Start Buttons
    case 0x02:
        return readinputport(0);		// P1+P2
    case 0x08:
        return readinputport(2);		// DSW 1
    case 0x0a:
        return readinputport(3);		// DSW 2
    case 0x3e:
        return OKIM6295_status_0_r(0);	// OKI Status
