...
WRITE_HANDLER(hal21_vreg0_w)
{
    hal21_vreg[0] = data;
}
WRITE_HANDLER(hal21_vreg1_w)
{
    hal21_vreg[1] = data;
}
WRITE_HANDLER(hal21_vreg2_w)
{
    hal21_vreg[2] = data;
}
WRITE_HANDLER(hal21_vreg3_w)
{
    hal21_vreg[3] = data;
}
WRITE_HANDLER(hal21_vreg4_w)
{
    hal21_vreg[4] = data;
}
WRITE_HANDLER(hal21_vreg5_w)
{
    hal21_vreg[5] = data;
}
...
static READ_HANDLER(shared_auxram_r)
{
    return shared_auxram[offset];
}
static WRITE_HANDLER(shared_auxram_w)
{
