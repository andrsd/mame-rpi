...
WRITE_HANDLER(berzerk_magicram_w)
{
    ...
    case 0x00:
        berzerk_magicram[offset] = data2;
        break;
    case 0x10:
        berzerk_magicram[offset] = data2 |  videoram[offset];
        break;
    case 0x20:
        berzerk_magicram[offset] = data2 | ~videoram[offset];
        break;
    case 0x30:
        berzerk_magicram[offset] = 0xff;
        break;
    case 0x40:
        berzerk_magicram[offset] = data2 & videoram[offset];
        break;
    case 0x50:
        berzerk_magicram[offset] = videoram[offset];
        break;
    case 0x60:
        berzerk_magicram[offset] = ~(data2 ^ videoram[offset]);
        break;
