...
WRITE_HANDLER(m107_control_w)
{
    ...
    case 0x11:
        if ((m107_control[0x10] & 0x80) == 0x80) pf1_enable = 0;
        else pf1_enable = 1;
        if ((m107_control[0x10] & 0x02) == 0x02) pf1_rowscroll = 1;
        else pf1_rowscroll = 0;
    ...
    case 0x13:
        if ((m107_control[0x12] & 0x80) == 0x80) pf2_enable = 0;
        else pf2_enable = 1;
        if ((m107_control[0x12] & 0x02) == 0x02) pf2_rowscroll = 1;
        else pf2_rowscroll = 0;
    ...
    case 0x15:
        if ((m107_control[0x14] & 0x80) == 0x80) pf3_enable = 0;
        else pf3_enable = 1;
        if ((m107_control[0x14] & 0x02) == 0x02) pf3_rowscroll = 1;
        else pf3_rowscroll = 0;
    ...
    case 0x17:
        if ((m107_control[0x16] & 0x80) == 0x80) pf4_enable = 0;
        else pf4_enable = 1;
        if ((m107_control[0x16] & 0x02) == 0x02) pf4_rowscroll = 1;
        else pf4_rowscroll = 0;
