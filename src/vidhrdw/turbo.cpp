...
int turbo_vh_start(void)
{
    ...
    if (Machine->orientation) {
        ...
        if (Machine->orientation & ORIENTATION_SWAP_XY) {
            ...
            startx = starty;
            starty = temp;
            temp = adjusted_clip.min_x;
            adjusted_clip.min_x = adjusted_clip.min_y;
            adjusted_clip.min_y = temp;
            temp = adjusted_clip.max_x;
            adjusted_clip.max_x = adjusted_clip.max_y;
            adjusted_clip.max_y = temp;
        }
