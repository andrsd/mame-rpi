...
{
    return mnchmobl_sprite_xpos[offset];
}
WRITE_HANDLER(mnchmobl_sprite_xpos_w)
{
    mnchmobl_sprite_xpos[offset] = data;
}

READ_HANDLER(mnchmobl_sprite_attr_r)
{
    return mnchmobl_sprite_attr[offset];
}
WRITE_HANDLER(mnchmobl_sprite_attr_w)
{
    mnchmobl_sprite_attr[offset] = data;
}

READ_HANDLER(mnchmobl_sprite_tile_r)
{
    return mnchmobl_sprite_tile[offset];
}
WRITE_HANDLER(mnchmobl_sprite_tile_w)
{
    mnchmobl_sprite_tile[offset] = data;
}
...
{
    dirtybuffer = (unsigned char*) malloc(0x100);
