...
WRITE_HANDLER(dynduke_gfxbank_w)
{
    ...
    if (data & 0x01) back_bankbase = 0x1000;
    else back_bankbase = 0;
    if (data & 0x10) fore_bankbase = 0x1000;
    else fore_bankbase = 0;
...
WRITE_HANDLER(dynduke_control_w)
{
    ...
    if (data & 0x1) back_enable = 0;
    else back_enable = 1;
    if (data & 0x2) back_palbase = 16;
    else back_palbase = 0;
    if (data & 0x4) fore_enable = 0;
    else fore_enable = 1;
    if (data & 0x8) sprite_enable = 0;
    else sprite_enable = 1;
