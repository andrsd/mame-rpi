...
{
    return READ_WORD(&nemesis_xscroll1[offset]);
}
READ_HANDLER(gx400_xscroll2_r)
{
    return READ_WORD(&nemesis_xscroll2[offset]);
}
READ_HANDLER(gx400_yscroll_r)
{
    return READ_WORD(&nemesis_yscroll[offset]);
}

WRITE_HANDLER(gx400_xscroll1_w)
{
    COMBINE_WORD_MEM(&nemesis_xscroll1[offset], data);
}
WRITE_HANDLER(gx400_xscroll2_w)
{
    COMBINE_WORD_MEM(&nemesis_xscroll2[offset], data);
}
WRITE_HANDLER(gx400_yscroll_w)
{
    COMBINE_WORD_MEM(&nemesis_yscroll[offset], data);
}
