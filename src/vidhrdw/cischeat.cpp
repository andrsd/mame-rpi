...
static int read_shift(void)
{
    ...
    case 1 :
        ret = 1;
        break;	// low  shift: button 3
    case 2 :
        ret = 0;
        break;	// high shift: button 4
    }
    return ret;
}
...
READ_HANDLER(cischeat_vregs_r)
{
    switch (offset) {
    case 0x0000 :
        return readinputport(1);	// Coins
    case 0x0002 :
        return readinputport(2) + (read_shift() << 1);	// Buttons
    case 0x0004 :
        return readinputport(3);	// Motor Limit Switches
    case 0x0006 :
        return readinputport(4);	// DSW 1 & 2
    case 0x0010 :
        switch (cischeat_ip_select & 0x3) {
        case 0 :
            return readinputport(6);	// Driving Wheel
        case 1 :
            return 0xFFFF;				// Cockpit: Up / Down Position?
        case 2 :
            return 0xFFFF;				// Cockpit: Left / Right Position?
        default:
            return 0xFFFF;
        }

    case 0x2200 :
        return readinputport(5);	// DSW 3 (4 bits)
    case 0x2300 :
        return soundlatch2_r(0);	// From sound cpu
...
//		case 0x0002 :	return 0xFFFF;
    case 0x0004 :
        return readinputport(2) + (read_shift() << 5);	// Buttons
    case 0x0006 :
        return readinputport(3);	// ? Read at boot only
    case 0x0008 :
        return soundlatch2_r(0);	// From sound cpu
    case 0x000c :
        return readinputport(4);	// DSW 3
...
WRITE_HANDLER(cischeat_vregs_w)
{
    ...
    case 0x0010   :
        cischeat_ip_select = new_data;
        break;
    case 0x0012   :
        break; // value above + 1

    case 0x2000+0 :
        MEGASYS1_VREG_SCROLL(0, x)		break;
    case 0x2000+2 :
        MEGASYS1_VREG_SCROLL(0, y)		break;
    case 0x2000+4 :
        MEGASYS1_VREG_FLAG(0)			break;

    case 0x2008+0 :
        MEGASYS1_VREG_SCROLL(1, x)		break;
    case 0x2008+2 :
        MEGASYS1_VREG_SCROLL(1, y)		break;
    case 0x2008+4 :
        MEGASYS1_VREG_FLAG(1)			break;

    case 0x2100+0 :
        MEGASYS1_VREG_SCROLL(2, x)		break;
    case 0x2100+2 :
        MEGASYS1_VREG_SCROLL(2, y)		break;
    case 0x2100+4 :
        MEGASYS1_VREG_FLAG(2)			break;

    case 0x2108   :
        break;	// ? written with 0 only
    case 0x2208   :
        break;	// watchdog reset
    ...
    case 0x2308   :
        cpu_set_reset_line(1, (new_data & 2) ? ASSERT_LINE : CLEAR_LINE);
...
WRITE_HANDLER(f1gpstar_vregs_w)
{
    ...
    */
    ...
    case 0x2308   :
        cpu_set_reset_line(1, (new_data & 1) ? ASSERT_LINE : CLEAR_LINE);
        cpu_set_reset_line(2, (new_data & 2) ? ASSERT_LINE : CLEAR_LINE);
...
void cischeat_draw_road(struct osd_bitmap *bitmap, int road_num, int priority1, int priority2, int transparency)
{
    ...
    if (priority1 < priority2)	{
        min_priority = priority1;
        max_priority = priority2;
    } else						{
        min_priority = priority2;
        max_priority = priority1;
    }
