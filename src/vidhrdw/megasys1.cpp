...
int megasys1_vh_start(void)
{
    ...
    */
    ...
    megasys1_8x8_scroll_0_factor = 1;
    megasys1_16x16_scroll_0_factor = 4;
    megasys1_8x8_scroll_1_factor = 1;
    megasys1_16x16_scroll_1_factor = 4;
    megasys1_8x8_scroll_2_factor = 1;
    megasys1_16x16_scroll_2_factor = 4;

    if (Machine->gamedrv == &driver_soldamj) {
        megasys1_8x8_scroll_1_factor = 4;
        megasys1_16x16_scroll_1_factor = 4;
    }
...
WRITE_HANDLER(megasys1_vregs_A_w)
{
    ...
    switch (offset) {
    case 0x000   :
        megasys1_active_layers = new_data;
        break;
    ...
    case 0x100   :
        megasys1_sprite_flag = new_data;
        break;

    case 0x300   :
        megasys1_screen_flag = new_data;
        if (new_data & 0x10)
...
void megasys1_vh_screenrefresh(struct osd_bitmap *bitmap, int full_refresh)
{
    ...
    for (i = 0; i < 5; i++) {
        ...
        switch (layer) {
        case 0:
            MEGASYS1_TMAP_DRAW(0)	break;
        case 1:
            MEGASYS1_TMAP_DRAW(1)	break;
        case 2:
            MEGASYS1_TMAP_DRAW(2)	break;
        case 3:
        case 4:
            if (flag != 0) {
                flag = 0;
            ...
            if (megasys1_active_layers & 0x08) {
                ...
                else if (layer == 3)	draw_sprites(bitmap, -1);
            }
