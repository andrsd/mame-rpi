...
READ_HANDLER(wardner_videoram_r)
{
    ...
    switch (offset) {
    case 0:
        memdata =  twincobr_txram_r(0) & 0x00ff;
        break;
    case 1:
        memdata = (twincobr_txram_r(0) & 0xff00) >> 8;
        break;
    case 2:
        memdata =  twincobr_bgram_r(0) & 0x00ff;
        break;
    case 3:
        memdata = (twincobr_bgram_r(0) & 0xff00) >> 8;
        break;
    case 4:
        memdata =  twincobr_fgram_r(0) & 0x00ff;
        break;
    case 5:
        memdata = (twincobr_fgram_r(0) & 0xff00) >> 8;
        break;
    }
    return memdata;
}
...
WRITE_HANDLER(wardner_videoram_w)
{
    ...
    switch (offset) {
    case 0:
        memdata = twincobr_txram_r(0) & 0xff00;
        memdata |= data;
        twincobr_txram_w(0, memdata);
        break;
    case 1:
        memdata = twincobr_txram_r(0) & 0x00ff;
        memdata |= (data << 8);
        ...
        break;
    case 2:
        memdata = twincobr_bgram_r(0) & 0xff00;
        memdata |= data;
        twincobr_bgram_w(0, memdata);
        break;
    case 3:
        memdata = twincobr_bgram_r(0) & 0x00ff;
        memdata |= (data << 8);
        ...
        break;
    case 4:
        memdata = twincobr_fgram_r(0) & 0xff00;
        memdata |= data;
        twincobr_fgram_w(0, memdata);
        break;
    case 5:
        memdata = twincobr_fgram_r(0) & 0x00ff;
        memdata |= (data << 8);
    ...
    if (twincobr_display_on) {
        ...
        for (offs = (31 * 41) - 1; offs >= 0; offs--) {
            ...
            if (twincobr_flip_screen) {
                sx = 40 - sx;
                sy = 30 - sy;
                xpos = (sx * 8) - (7 - (scroll_x & 7));
                ypos = (sy * 8) - (7 - (scroll_y & 7));
            } else {
                xpos = (sx * 8) - (scroll_x & 7);
                ypos = (sy * 8) - (scroll_y & 7);
            }
